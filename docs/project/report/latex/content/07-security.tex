...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{security/gitleaks-scan-success.png}
\caption{Stage Secret Scanning chạy thành công (không phát hiện secret)}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{security/gitleaks-scan-failed.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{security/sonarqube-dashboard.png}
\caption{SonarQube Dashboard: project \texttt{yas} với Quality Gate Passed}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{security/sonarqube-pipeline-stages.png}
\caption{Jenkins pipeline: stage Code Quality và Quality Gate chạy thành công}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{security/sonarqube-build-success.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{security/snyk-dashboard.png}
\caption{Snyk Dashboard: danh sách project và vulnerability được phát hiện}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{security/snyk-scan-success.png}
\caption{Stage Dependency Scan trong Jenkins pipeline chạy thành công}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{security/snyk-full-pipeline.png}
...
\begin{table}[H]
\centering
\caption{Vấn đề gặp phải khi tích hợp Security Scanning}
\begin{tabular}{|p{4.5cm}|p{4.5cm}|p{4.5cm}|}
\hline
\textbf{Vấn đề} & \textbf{Nguyên nhân} & \textbf{Giải pháp} \\
\hline
\texttt{gitleaks: command not found} tại Pre-check & Gitleaks chưa được cài trên Jenkins agent & Cài \texttt{brew install gitleaks} trên agent \\
\hline
Gitleaks phát hiện 13 findings, pipeline FAIL & Keycloak client secret từ upstream repo bị nhận nhầm là secret thật & Thêm \texttt{commits} allowlist vào \texttt{gitleaks.toml} cho 8 commit từ upstream \\
\hline
Snyk chạy xong nhưng không thấy project trên dashboard & \texttt{snyk test} chỉ quét local, không đẩy lên dashboard & Thêm \texttt{snyk monitor} vào stage \\
\hline
\end{tabular}
\end{table}
