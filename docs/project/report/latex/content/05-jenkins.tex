...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{jenkins/jenkins-dashboard.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{jenkins/webhook-config.jpg}
\caption{Cấu hình Webhook trên GitHub}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{jenkins/webhook-pr-trigger.jpg}
\caption{Cấu hình trigger event Pull Request cho Webhook}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{jenkins/webhook-ping-success.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{jenkins/multibranch-config-1.jpg}
\caption{Cấu hình Multibranch Pipeline Job (1)}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{jenkins/multibranch-config-2.jpg}
\caption{Cấu hình Multibranch Pipeline Job (2)}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{jenkins/multibranch-config-pat.jpg}
\caption{Cấu hình Personal Access Token cho Multibranch Pipeline}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{jenkins/multibranch-scan-branches.jpg}
\caption{Multibranch Pipeline — danh sách branch được Jenkins phát hiện}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{jenkins/pipeline-auto-trigger.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{jenkins/pipeline-all-stages-success.jpg}
\caption{Tất cả stage pipeline chạy thành công}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{jenkins/pipeline-build-history.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{jenkins/agent-pool-nodes.png}
\caption{Danh sách Nodes trên Jenkins: 4 agent + Built-In Node}
\end{figure}

\subsubsection{Vấn Đề Gặp Phải Và Cách Giải Quyết}

\begin{table}[H]
\centering
\caption{Vấn đề gặp phải khi triển khai Jenkins}
\begin{tabular}{|p{4.5cm}|p{4.5cm}|p{4.5cm}|}
\hline
\textbf{Vấn đề} & \textbf{Nguyên nhân} & \textbf{Giải pháp} \\
\hline
Pipeline chạy quá chậm do build lại toàn bộ Monorepo & Jenkins mặc định thực thi toàn bộ project & Triển khai logic \texttt{git diff --name-only} để phát hiện service có thay đổi \\
\hline
Khó quản lý báo cáo Test/Coverage cho nhiều Microservices & Chạy gộp khiến kết quả chồng chéo & Dùng plugin \texttt{junit} và \texttt{jacoco} với đường dẫn động \texttt{\$\{service\}/target/...} \\
\hline
Test service \texttt{search} bị lỗi \texttt{IllegalStateException} & Khác biệt cấu hình Kafka giữa Local và CI & Bổ sung \texttt{spring.kafka.listener.ack-mode=manual} vào file properties \\
\hline
\end{tabular}
\end{table}
